...
<section class="content">
    <div class="card">
        <div class="card-header">
            <a href="#modal-tambah" data-toggle="modal" class="btn btn-primary"> Tambah admin baru</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?= site_url('pengguna/hapus/') . $data->id_user ?>" method="post">
                                    <button type="submit" class="btn btn-danger btn-sm" name="hadmin"> <i class="fa fa-trash"></i></button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title m-auto">Form tambah admin</h4>
            </div>
            <div class="modal-body">
                <form action="<?= site_url('pengguna/tambah') ?>" method="POST">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" name="tadmin">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h4 class="modal-title m-auto"> Form ubah admin</h4>
                </div>
                <div class="modal-body">
                    <form action="<?= site_url('pengguna/ubah/') . $data->id_user ?>" method="post">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal"> Cancel</button>
                            <button type="submit" class="btn btn-warning" name="uadmin"> Save changes</button>
                        </div>
                    </form>
